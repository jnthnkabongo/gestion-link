        ...
        <div class="card">
            <div class="card-header text-center">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <form class="row g-3" action="{{ route('index-recherche') }}" method="GET" style="color: #004B90">
                    ...
                    <div class="col-md-5">
                        <form class="row g-3" action="{{ route('index-filtre') }}" method="GET">
                            <div class="input-group mb-3">
                    ...
                    <tbody>
                        @forelse ($liste_system_data as $itemsystem)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{ route('modifier-lien', $itemsystem) }}"><i class="bi bi-pencil"></i></a>&nbsp;
                                    <a class="btn btn-danger" href="{{ route('suppression-lien', $itemsystem) }}"><i class="bi bi-trash"></i></a>
                                </td>
                            </tr>
                        @empty
