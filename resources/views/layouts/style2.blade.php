...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css" integrity="sha512-vKMx8UnXk60zUwyUnUPM3HbQo8QfmNx7+ltw8Pm5zLusl1XIfwcxo8DbWCqMGKaWeNxWA8yrx5v3SaVpMvR3CA==" crossorigin="anonymous" referrerpolicy="no-referrer" rel="stylesheet"/>
...
<body>
        ...
        <header id="header" class="bg-white header fixed-top d-flex align-items-center">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <a href="{{ route('user-liste-liens') }}" class="logo d-flex align-items-center">
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <li class="nav-item">
                <a class="nav-link " href="{{ route('user-liste-liens') }}">
