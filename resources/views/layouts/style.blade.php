                ...
                <ul class="d-flex align-items-center">
                    ...
                    @auth
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="{{ route('ajouter-lien') }}">
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="{{ route('liste-manager') }}">
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="{{ route('liste-departement') }}">
